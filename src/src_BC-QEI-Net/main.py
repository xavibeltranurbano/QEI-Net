...
def run_program(config, networkName, params):
    ...
    network = BC_Net(imgSize=params['targetSize'])
    ...
    with tf.device('/GPU:0'):
        ...
        utils.save_training_plots(history, f"/results/{networkName}/{params['currentFold']}/training_plots.png")
...
if __name__ == "__main__":
    ...
    for i in range(1, 6):
        ...
        os.makedirs(f"/results/{networkName}/{i}", exist_ok=True)  # Create folder for this experiment
