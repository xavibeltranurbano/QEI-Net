...
class FCDN_QEI:
    ...
    """def get_model(self):
        ...
        output1 = Dense(1, activation='linear')(dense16)
        output2 = Dense(1, activation='linear')(dense16)
        output3 = Dense(1, activation='linear')(dense16)
        output4 = Dense(1, activation='linear')(dense16)
        output5 = Dense(1, activation='linear')(dense16)
